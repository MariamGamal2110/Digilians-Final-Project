...
export default function AdminAddPunishmentModal({ onClose, onSave }) {
  const [studentName, setStudentName] = useState("");
  const [militaryNum, setMilitaryNum] = useState("");
  ...
  const handleSubmit = () => {
    ...
    onSave(newData); // 🔥 هنا الربط الحقيقي
  };

  return (
    <div className="modal">
      <h2>إضافة عقوبة جديدة</h2>
...
// export default function AdminAddPunishmentModule({ onClose, onAdd, onEdit, selectedRelative }) {
