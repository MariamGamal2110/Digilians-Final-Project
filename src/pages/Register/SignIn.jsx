...
const SignIn = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col bg-[rgb(var(--surface))] text-[rgb(var(--on-surface))] font-['Cairo'] flex flex-col items-center justify-center" dir="rtl">
        ...
        <div className="flex flex-col md:flex-row shadow-2xl rounded-[2rem] overflow-hidden bg-white border border-[rgb(var(--outline-variant))/0.2] glass-card min-h-[600px]">
          ...
          <div className="hidden md:flex md:w-1/2 relative overflow-hidden bg-[rgb(var(--primary-container))] satin-gradient">
            ...
            <div className="absolute top-0 right-0 p-10">
              <span className="material-symbols-outlined text-[rgb(var(--on-primary-container))] opacity-5 text-[12rem] select-none">military_tech</span>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center bg-white">
            <div className="mb-12 text-right">
              <div className="inline-block p-3 bg-[rgb(var(--surface-container-low))] rounded-2xl mb-4">
                <span className="material-symbols-outlined text-[rgb(var(--primary-container))] text-3xl">verified_user</span>
              </div>
              <h2 className="text-3xl font-black text-[rgb(var(--primary-container))] mb-2 tracking-tight">التحقق من الهوية</h2>
              <p className="text-[rgb(var(--on-surface))] opacity-60 font-bold text-sm">يرجى إكمال خطوات التحقق للوصول إلى السجلات الرسمية.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                <label className="block text-[11px] font-black uppercase tracking-[0.2em] text-[rgb(var(--outline-variant))] pr-1">البريد الإلكتروني الرسمي</label>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pr-1">
                  <label className="block text-[11px] font-black uppercase tracking-[0.2em] text-[rgb(var(--outline-variant))]">كلمة المرور المشفرة</label>
                  <button type="button" className="text-[10px] text-[rgb(var(--primary-container))] font-black hover:underline tracking-tighter uppercase">نسيت كلمة المرور؟</button>
                </div>
                <div className="relative group">
                  <input 
                    className="w-full bg-[rgb(var(--surface-container-low))] border-b-2 border-[rgb(var(--outline-variant))/0.3] focus:border-[rgb(var(--primary-container))] px-4 py-4 outline-none transition-all font-bold text-lg text-right rounded-t-xl"
              ...
              <div className="pt-6">
                <button 
                  type="submit"
                  className="w-full satin-gradient text-[rgb(var(--primary-container))] py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-4 hover:shadow-2xl hover:shadow-[rgb(var(--primary-container))/0.3] active:scale-[0.98] transition-all shadow-lg"
                >
                  تأكيد الدخول للنظام
            ...
            <div className="mt-16 pt-8 border-t border-[rgb(var(--outline-variant))/0.2] text-center">
              ...
              <p className="text-[10px] text-[rgb(var(--on-surface))] opacity-50 leading-relaxed font-bold uppercase tracking-widest">
                هذا النظام مخصص للموظفين المعتمدين فقط. <br /> جميع العمليات مسجلة ومراقبة استخباراتياً.
              </p>
            </div>
          </div>
        </div>
